...
// 默认唤醒词列表
export const DEFAULT_WAKE_WORDS = '小智\n小志';
const LEGACY_WAKE_WORDS = '你好小智\n你好小志\n小爱同学\n你好小鑫\n你好小新\n小美同学\n小龙小龙\n喵喵同学\n小滨小滨\n小冰小冰\n嘿你好呀';
...
export function loadConfig() {
    ...
    if (savedWakewordList !== null && savedWakewordList !== LEGACY_WAKE_WORDS && wakewordListInput) {
        wakewordListInput.value = savedWakewordList;
    } else if (wakewordListInput) {
        wakewordListInput.value = DEFAULT_WAKE_WORDS;
        localStorage.setItem('xz_tester_wakewordList', DEFAULT_WAKE_WORDS);
    }
